...
from .segment.router import segment_router, editor_segment_router, project_segment_router
...
from .credits.router import credits_router
...
api_router.include_router(project_segment_router)
